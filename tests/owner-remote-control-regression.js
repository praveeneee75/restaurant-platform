...
const checks = [
  ...
  }) && read('saas-backend/public/owner-control.html').includes('/owner-dashboard.html') && read('saas-backend/public/owner-control.html').includes('/downloads.html') && read('saas-backend/public/owner-control.html').includes('/owner-profile.html'), 'consistent owner portal navigation across pages'],
