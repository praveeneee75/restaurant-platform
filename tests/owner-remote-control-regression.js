...
const checks = [
  ...
  [read('saas-backend/public/owner-control.html').includes('@media(max-width:1540px)') && read('saas-backend/public/owner-control.html').includes('grid-template-columns:repeat(8,minmax(0,1fr))') && read('saas-backend/public/owner-control.html').includes('@media(max-width:460px)') && read('saas-backend/public/owner-control.html').includes('grid-template-columns:repeat(2,minmax(0,1fr))'), 'owner header auto-fits navigation across desktop zoom and narrow resolutions'],
