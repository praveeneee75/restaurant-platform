...
(async () => {
  ...
  const settings = {
    ...
    kot_header_font_type: 'FONT_B', kot_header_font_size: 'SMALL', kot_header_alignment: 'RIGHT', kot_header_bold: '1',
    ...
    kot_items_font_type: 'FONT_B', kot_items_font_size: 'SMALL', kot_items_alignment: 'LEFT', kot_items_bold: '0',
    ...
    bill_title_font_type: 'FONT_A', bill_title_font_size: 'LARGE', bill_title_alignment: 'CENTER', bill_title_bold: '1',
    bill_details_font_type: 'FONT_B', bill_details_font_size: 'SMALL', bill_details_alignment: 'LEFT', bill_details_bold: '0',
